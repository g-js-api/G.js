...
let counter = (num = 0, use_id = false, persistent = false, timer = false) => {
    ...
    let exports = {
        ...
        abs: () => {
            $.add(item_edit(undefined, exports.item, exports.item, NONE, ITEM, ITEM, EQ, undefined, undefined, 1, ABS));
        },
        neg: () => {
            $.add(item_edit(undefined, exports.item, exports.item, NONE, ITEM, ITEM, EQ, undefined, undefined, 1, NEG));
        }
    };
    if (persistent) {
...
let float_counter = (val = 0) => {
    ...
    c_item.reset = () => c_item.set(0);
    c_item.abs = () => {
        $.add(item_edit(undefined, exports.item, exports.item, NONE, TIMER, TIMER, EQ, undefined, undefined, 1, ABS));
    };
    c_item.neg = () => {
        $.add(item_edit(undefined, exports.item, exports.item, NONE, TIMER, TIMER, EQ, undefined, undefined, 1, NEG));
    };
    c_item.round = () => {
        $.add(item_edit(undefined, exports.item, exports.item, NONE, TIMER, TIMER, EQ, undefined, undefined, 1, undefined, undefined, RND));
    };
    return c_item;
}

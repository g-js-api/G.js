 ...
 * @param {number} easing_rate How smoothly the effect should start
 ...
 */
let camera_static = (gr, duration = 0, easing = NONE, easing_rate = 0, exit_instant = false, exit_static = false, smooth_vel = false, smooth_vel_mod = 0, follow = false, x_only = false, y_only = false) => {
...
* @param {group} id Group ID of target object
* @param {bool} no_effects Weather the teleport trigger generates an effect
*/

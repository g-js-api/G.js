 ...
 * @param {array} tint What color to tint with
 * @param {array} brightness The brightness of the each of the RGB color channels 
 * @param {easing} easing How smoothly the effect should start
 * @param {number} duration How long it takes to start the effect
 * @param {easing} easing How smoothly the effect should start
 * @param {number} easing_rate How smoothly the effect should start
 */
let edit_color = (tint = rgb(255, 255, 255), brightness = [0,0,0], duration = 0, easing = NONE, easing_rate = 2) => {
    $.add(trigger({
        OBJ_ID: 2923,
        155: true,
        176: tint[0],
